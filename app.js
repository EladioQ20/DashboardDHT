(() => {
  ...
  // ----------------------------
  const SUPABASE_URL = "https://ncoieieeihooveochnbl.supabase.co"; // Cambia aquí
  const SUPABASE_KEY = "sb_publishable_5YYIuLsxZXPayd0WRBzZWA_hmL7GKTi";// Cambia aquí
  ...
  // ----------------------------
  const myChannel = supabaseClient.channel('table-db-changes')
